...
//Reaproveitei parte do codigo do professor. Modifiquei para tratar com chaves que sao nomes
// Implementei listas ligadas para lidar com as colisoes.
...
void le_arquivo(char *nomearq1, char *nomearq2)
{
    ...
    busca_no_hash(novo_hash, nomearq2);
